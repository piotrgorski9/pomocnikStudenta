package com.example.pomocnikstudenta.Adapter
...
import com.example.pomocnikstudenta.R
...
class NotesAdapter(private val context: Context, val listener: NotesClickListener) :
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        holder.date.text = currentNote.data
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val Note_tv = itemView.findViewById<TextView>(R.id.tvNotatka)
        val date = itemView.findViewById<TextView>(R.id.tvData)
